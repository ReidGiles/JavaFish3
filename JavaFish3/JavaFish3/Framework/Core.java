 ...
 * @version 0.4
 */
public class Core implements IWorld, IInput
{
    ...
    public void update() throws WorldDoesNotExistException
    {
        ...
        {
            throw new WorldDoesNotExistException("Cannot update the 3D world until it has been created");
        }
